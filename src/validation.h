...
extern bool fAddressIndex; // eurekacoin
...
public:
    ...
    ByteCodeExec(const CBlock& _block, std::vector<EurekaCoinTransaction> _txs, const uint64_t _blockGasLimit) : txs(_txs), block(_block), blockGasLimit(_blockGasLimit) {}
