...
#include "titlebar.h"
#include "eurekacoinversionchecker.h"
    ...
    platformStyle(_platformStyle)
{
    ...
    if(fCheckForUpdates && eurekacoinVersionChecker->newVersionAvailable())
    {
...
void BitcoinGUI::createActions()
{
    ...
    openAction->setStatusTip(tr("Open a eurekacoin: URI or payment request"));
